...
# SOURCE = "../datasets/AICity_data/train/S03/c010/det/det_ssd512.txt"
SOURCE = "../datasets/AICity_data/train/S03/c010/det/det_yolo3.txt"
...
def predict(frame):
    ...
    if ANN_PER_FRAME is None:
        ANN_PER_FRAME = obtain_data(SOURCE)
