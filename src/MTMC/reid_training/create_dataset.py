...
out_dir = "../aic19-track1-mtmc/aic20_reID_bboxes/bounding_box_test"
...
def main():
    ...
    for scene_dir in scene_dirs:
        ...
        for camera_dir in camera_dirs:
            print(camera_dir)
            camID = camera_dir.rsplit("/", 1)[-1]
            
            video_path = camera_dir + '/vdo.avi'
            det_path = camera_dir + '/gt/gt.txt'
            ...
            for i in range(0, all_frames):
                ...
                if tmp_i in frame_dict:
                    ...
                    for det_box in boxes:
                        ...
                        img_name = f"{det_box.id}_{camID}_{str(image_count).zfill(10)}.jpg"
                        image_count += 1
                        out_path_img = os.path.join(out_dir, img_name)
                        # print("saving..", out_path_img)
                        cv2.imwrite(out_path_img, cropped_img)
